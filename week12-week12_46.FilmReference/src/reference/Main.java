...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ratings.addRating(thomas, bluesBrothers, Rating.FINE);
        ratings.addRating(thomas, theBridgesOfMadisonCounty, Rating.MEDIOCRE);
        ...
        System.out.println(pekka + " recommendation: " + ref.recommendFilm(arto));
